...
export const loadSettings = () => {
  try {
    ...
    return savedSettings ? JSON.parse(savedSettings) : { apiBaseUrl: '', timeout: 5 }
  } catch (error) {
    console.error('Error loading settings:', error)
    return { apiBaseUrl: '', timeout: 5 }
  }
}
 ...
 */
export const generateImage = async (params, baseUrl = '', timeout = 5) => {
  // Use the provided base URL or default to relative path
