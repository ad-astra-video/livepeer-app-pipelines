...
import { getDefaultWhipUrl, getDefaultWhepUrl, getDefaultDataStreamUrl, getDefaultKafkaEventsUrl } from '../utils/urls'
  ...
  const loadSettingsFromStorage = (): UrlSettings => {
    try {
      ...
      if (saved) {
        ...
        return {
          whipUrl: parsed.whipUrl || getDefaultWhipUrl(),
